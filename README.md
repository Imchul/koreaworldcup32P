...
- 결정적 3경기와 현재 상태:
  ...
  | 6/28 08:30 | K | DR콩고 vs 우즈베키스탄 | DR콩고가 **이기지만 않으면** (우즈벡 6골차↑ 승은 불리) | ⏳ 대기 |
  | 6/28 11:00 | J | 알제리 vs 오스트리아 | **오스트리아 승** 또는 알제리 2골차↑ 승 | ⏳ 대기 |
- 한국보다 좋은 3위를 만든 위험 조가 **0~1개면 진출(7~8위), 2개 이상이면 탈락(9위↓)**.
- **현재(6/28 L조 종료 기준)**: 위험 1조(L)가 이미 불리로 확정 → 한국은 **8위 진출권이지만 탈락 위험**.
  남은 **K·J가 모두 한국에 유리해야 8위로 진출**하고, **둘 중 하나라도 불리하면 9위 이하로 탈락**한다.
